...
public class TestSuccessfulDLIssuesFileFireFox extends TestBase

{

  @Test (dataProvider = "dataProvider")
  public void testSuccessfulIssuesFileDownLoadFiref(String username, String password, String downloadPath, 
		  String filename) throws InterruptedException, IOException, AWTException 
  {
	
	  
	boolean testResult = loginpage.login(username, password)
								  .DownloadIssuesListFirefox()
